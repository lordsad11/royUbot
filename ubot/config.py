...
KYNAN = list(map(int, os.getenv("ubt", "5302505460").split()))

API_ID = int(os.getenv("API_ID", "23806826"))

API_HASH = os.getenv("API_HASH", "8da7a71f393f6149c7e1bc36731fca9a")

BOT_TOKEN = os.getenv("BOT_TOKEN", "7123261167:AAFpKR5Pnk4V9F44oGB71lXw16QzSGPi7m8")

OWNER_ID = int(os.getenv("OWNER_ID", "5302505460"))

USER_ID = list(map(int, os.getenv("USER_ID", "5302505460").split()))

SUDO_USERS = list(map(int, os.getenv("SUDO_USERS", "6583031844").split()))

DB_SUDO = list(map(int, os.getenv("DB_SUDO", "5302505460").split()))

LOG_UBOT = int(os.getenv("LOG_UBOT", "-1002024655650"))

LOG_SELLER = int(os.getenv("LOG_SELLER", "-1002024655650"))
...
MONGO_URL = os.getenv(
    "MONGO_URL",
    "mongodb+srv://ubot:1@cluster1.24liyjv.mongodb.net/?retryWrites=true&w=majority",
)
