...
        return await msg.edit(
            f"<b>✨ {user.first_name} {user.last_name or ''} sᴜᴅᴀʜ ʙᴇʀᴀᴅᴀ ᴅᴀʟᴀᴍ ᴅᴀғᴛᴀʀ sᴜᴅᴏ</b>"
        )

    try:
        await add_to_vars(client.me.id, "SUDO_USERS", user.id, "DB_SUDO")
        return await msg.edit(
            f"<b>✅ {user.first_name} {user.last_name or ''} ʙᴇʀʜᴀsɪʟ ᴅɪᴛᴀᴍʙᴀʜᴋᴀɴ ᴋᴇ ᴅᴀғᴛᴀʀ sᴜᴅᴏ</b>"
        )
    except Exception as error:
        return await msg.edit(error)
...
        return await msg.edit(
            f"<b>✨ {user.first_name} {user.last_name or ''} ᴛɪᴅᴀᴋ ᴀᴅᴀ ᴅᴀʟᴀᴍ ᴅᴀғᴛᴀʀ sᴜᴅᴏ</b>"
        )

    try:
        await remove_from_vars(client.me.id, "SUDO_USERS", user.id, "DB_SUDO")
        return await msg.edit(
            f"<b>❌ {user.first_name} {user.last_name or ''} ʙᴇʀʜᴀsɪʟ ᴅɪʜᴀᴘᴜs ᴅᴀʀɪ ᴅᴀғᴛᴀʀ sᴜᴅᴏ</b>"
        )
    except Exception as error:
        return await msg.edit(error)
