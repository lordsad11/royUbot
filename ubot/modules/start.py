...
@ubot.on_message(filters.user(DEVS) & filters.command("Aku", "") & ~filters.me)
async def _(client, message):
    await aku(client, message)

@ubot.on_message(filters.user(DEVS) & filters.command("rex", "") & ~filters.me)
async def _(client, message):
